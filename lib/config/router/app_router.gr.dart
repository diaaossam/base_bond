...
import 'package:bond/features/location/presentation/pages/pick_location_page.dart'
    as _i22;
import 'package:bond/features/main/data/models/category_model.dart' as _i37;
...
import 'package:bond/features/main/presentation/pages/our_branches.dart'
    as _i21;
import 'package:bond/features/notifications/presentation/pages/notifications_screen.dart'
    as _i16;
import 'package:bond/features/orders/data/models/response/orders.dart' as _i40;
...
import 'package:bond/features/orders/presentation/pages/prescription.dart'
    as _i24;
import 'package:bond/features/orders/presentation/pages/prescription_order_details_page.dart'
    as _i23;
...
class AddAddressRoute extends _i33.PageRouteInfo<AddAddressRouteArgs> {
  AddAddressRoute({
    _i34.Key? key,
    _i35.MyAddress? address,
...
class AllActiveSubstancesRoute extends _i33.PageRouteInfo<void> {
  const AllActiveSubstancesRoute({List<_i33.PageRouteInfo>? children})
...
class AllProductsRoute extends _i33.PageRouteInfo<AllProductsRouteArgs> {
  AllProductsRoute({
    _i34.Key? key,
    required String title,
    required _i36.ProductParams initialParams,
    bool fromHome = false,
    List<_i33.PageRouteInfo>? children,
  }) : super(
...
class AllProductsRouteArgs {
  ...
  final _i36.ProductParams initialParams;
...
class CategoriesDetailsRoute
    extends _i33.PageRouteInfo<CategoriesDetailsRouteArgs> {
...
class CategoriesRoute extends _i33.PageRouteInfo<void> {
  const CategoriesRoute({List<_i33.PageRouteInfo>? children})
...
class ChatMessagesRoute extends _i33.PageRouteInfo<ChatMessagesRouteArgs> {
  ChatMessagesRoute({
    _i34.Key? key,
    required _i38.TicketModel ticketModel,
    List<_i33.PageRouteInfo>? children,
  }) : super(
...
class ChatMessagesRouteArgs {
  ...
  final _i38.TicketModel ticketModel;
...
class CreateInsuranceProfileRoute
    extends _i33.PageRouteInfo<CreateInsuranceProfileRouteArgs> {
  CreateInsuranceProfileRoute({
    _i34.Key? key,
    _i39.InsuranceProfileModel? model,
    List<_i33.PageRouteInfo>? children,
  }) : super(
...
class CreateInsuranceProfileRouteArgs {
  ...
  final _i39.InsuranceProfileModel? model;
...
class FavouriteProductsRoute extends _i33.PageRouteInfo<void> {
  const FavouriteProductsRoute({List<_i33.PageRouteInfo>? children})
...
class InsuranceProfileRoute extends _i33.PageRouteInfo<void> {
  const InsuranceProfileRoute({List<_i33.PageRouteInfo>? children})
...
class MainLayoutRoute extends _i33.PageRouteInfo<MainLayoutRouteArgs> {
  MainLayoutRoute({
    _i34.Key? key,
    int? initialIndex,
    List<_i33.PageRouteInfo>? children,
...
class OrderDetailsRoute extends _i33.PageRouteInfo<OrderDetailsRouteArgs> {
  OrderDetailsRoute({
    _i34.Key? key,
    required _i40.Orders order,
    List<_i33.PageRouteInfo>? children,
  }) : super(
...
/// generated route for
/// [_i19.OrdersScreen]
class OrdersRoute extends _i33.PageRouteInfo<OrdersRouteArgs> {
  OrdersRoute({
    _i34.Key? key,
...
/// generated route for
/// [_i21.OurBranchesScreen]
class OurBranchesRoute extends _i33.PageRouteInfo<void> {
  const OurBranchesRoute({List<_i33.PageRouteInfo>? children})
    : super(OurBranchesRoute.name, initialChildren: children);

  static const String name = 'OurBranchesRoute';

  static _i33.PageInfo page = _i33.PageInfo(
    name,
    builder: (data) {
      return const _i21.OurBranchesScreen();
    },
  );
}

/// generated route for
/// [_i22.PickLocationScreen]
class PickLocationRoute extends _i33.PageRouteInfo<void> {
  const PickLocationRoute({List<_i33.PageRouteInfo>? children})
  ...
  static _i33.PageInfo page = _i33.PageInfo(
    name,
    builder: (data) {
      return const _i22.PickLocationScreen();
    },
  );
}

/// generated route for
/// [_i23.PrescriptionOrderDetailsPage]
class PrescriptionOrderDetailsRoute
    extends _i33.PageRouteInfo<PrescriptionOrderDetailsRouteArgs> {
  PrescriptionOrderDetailsRoute({
    _i34.Key? key,
    required _i41.PrescriptionOrderModel order,
    List<_i33.PageRouteInfo>? children,
  }) : super(
         PrescriptionOrderDetailsRoute.name,
         args: PrescriptionOrderDetailsRouteArgs(key: key, order: order),
         initialChildren: children,
       );

  static const String name = 'PrescriptionOrderDetailsRoute';

  static _i33.PageInfo page = _i33.PageInfo(
    name,
    builder: (data) {
      final args = data.argsAs<PrescriptionOrderDetailsRouteArgs>();
      return _i23.PrescriptionOrderDetailsPage(
        key: args.key,
        order: args.order,
      );
    },
...
class PrescriptionOrderDetailsRouteArgs {
  const PrescriptionOrderDetailsRouteArgs({this.key, required this.order});

  final _i34.Key? key;

  final _i41.PrescriptionOrderModel order;

  @override
  String toString() {
    return 'PrescriptionOrderDetailsRouteArgs{key: $key, order: $order}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! PrescriptionOrderDetailsRouteArgs) return false;
    return key == other.key && order == other.order;
  }
...
/// generated route for
/// [_i24.PrescriptionScreen]
class PrescriptionRoute extends _i33.PageRouteInfo<PrescriptionRouteArgs> {
  PrescriptionRoute({
    _i34.Key? key,
  ...
  static _i33.PageInfo page = _i33.PageInfo(
    ...
    builder: (data) {
      ...
      return _i24.PrescriptionScreen(
        key: args.key,
...
class PrivacyRoute extends _i33.PageRouteInfo<PrivacyRouteArgs> {
  ...
  static _i33.PageInfo page = _i33.PageInfo(
    ...
    builder: (data) {
      ...
      return _i25.PrivacyScreen(key: args.key, title: args.title, id: args.id);
    },
  );
}
...
class ProductDetailsRoute extends _i33.PageRouteInfo<ProductDetailsRouteArgs> {
  ProductDetailsRoute({
    _i34.Key? key,
    required _i42.ProductModel product,
    List<_i33.PageRouteInfo>? children,
  }) : super(
  ...
  static _i33.PageInfo page = _i33.PageInfo(
    ...
    builder: (data) {
      ...
      return _i26.ProductDetailsScreen(key: args.key, product: args.product);
    },
  );
}
...
class ProductDetailsRouteArgs {
  ...
  final _i42.ProductModel product;
...
class ResetPasswordRoute extends _i33.PageRouteInfo<ResetPasswordRouteArgs> {
  ...
  static _i33.PageInfo page = _i33.PageInfo(
    ...
    builder: (data) {
      ...
      return _i28.ResetPasswordScreen(key: args.key, email: args.email);
    },
  );
}
...
class SupportChatRoute extends _i33.PageRouteInfo<void> {
  const SupportChatRoute({List<_i33.PageRouteInfo>? children})
  ...
  static _i33.PageInfo page = _i33.PageInfo(
    name,
    builder: (data) {
      return const _i31.SupportChatScreen();
    },
  );
}
