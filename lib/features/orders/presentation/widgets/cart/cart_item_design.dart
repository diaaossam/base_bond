                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: AppText(
                            text: "${((cartItem.currentItemPrice??cartItem.price ??1) * (cartItem.qty??1)).toStringAsFixed(2)} ${context.localizations.iqd}",
                          ...
                          InkWell(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10.w),
                                AppText(text: context.localizations.outOfStock,color: context.colorScheme.error,),
                              ],
                            ),
                          )
                          else
